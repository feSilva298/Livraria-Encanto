    ...
    <header className="bg-cyan-600 shadow-lg md:max-2xl relative">
      <nav className="flex flex-row md:mx-auto items-center">
        ...
        <div className="flex justify-center">
          <div className="h-10 shadow-xl">
            <input
              type="text"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="py-2 pr-[250px] pl-5 rounded-l-xl  outline-none  placeholder-gray-400 
            ...
            <button
              ...
              className=" w-16 h-[40px] bg-indigo-400 outline-none border-2 
